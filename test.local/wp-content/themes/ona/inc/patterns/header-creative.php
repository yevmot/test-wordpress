...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-column is-vertically-aligned-center ona-sm-down-order-1" style="flex-basis:20%">
			<!-- wp:site-title {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"5px"},"elements":{"link":{"color":{"text":"var:preset|color|light"}}}},"className":"ona-site-title ona-sm-down-text-align-left","fontSize":"medium","fontFamily":"base"} /-->
			
			<!-- wp:site-tagline {"style":{"typography":{"fontSize":"12px"}},"textColor":"light","className":"ona-sm-down-text-align-left"} /--></div>
			...
			<!-- wp:navigation {"textColor":"light","overlayBackgroundColor":"dark","overlayTextColor":"text-light","className":"is-style-default","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal"}} -->
			...
			<div class="wp-block-column is-vertically-aligned-center hide-md-down" style="flex-basis:20%"><!-- wp:social-links {"iconBackgroundColor":"dark","iconBackgroundColorValue":"#010101","layout":{"type":"flex","justifyContent":"right"},"style":{"spacing":{"blockGap":"10px"}}} -->
