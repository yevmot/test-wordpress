...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-group has-dark-background-color has-background" style="padding-top:100px"><!-- wp:group {"layout":{"contentSize":"1170px"}} -->
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%"><!-- wp:heading {"style":{"typography":{"lineHeight":"1.2"}},"textColor":"light","fontSize":"large"} -->
			<h2 class="wp-block-heading has-light-color has-text-color has-large-font-size" id="join-the-newsletter-to-get-the-daily-tips-latest-articles-and-free-stuffs-delivered-directly-to-your-inbox" style="line-height:1.2">' . __( 'Subscribe to New Posts', 'ona' ) . '</h2>
			<!-- /wp:heading --></div>
			<!-- /wp:column -->
			...
			<div class="wp-block-group" style="padding-right:20%"><!-- wp:paragraph {"textColor":"light","fontSize":"small"} -->
			<p class="has-light-color has-text-color has-small-font-size">' . __( 'A minimal, functional theme. All the latest news and creative articles are available at our news portal to encourage inspiration.', 'ona' ) . '</p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:group --></div>
			<!-- /wp:column -->
			...
			<!-- wp:navigation {"textColor":"light","overlayMenu":"never","layout":{"type":"flex","justifyContent":"left","orientation":"vertical"},"style":{"spacing":{"blockGap":"16px"},"typography":{"fontSize":"1.125rem"}}} -->
			...
			<p class="ona-copyright has-text-light-color has-text-color has-link-color has-tiny-font-size">' . sprintf( __( '© %d Powered by ', 'ona' ), date_i18n("Y")) . '<a href="https://deothemes.com/wordpress-themes/ona-block-wordpress-theme/" style="color:inherit">' . esc_html__( 'Ona WordPress theme', 'ona' ) . '</a></p>
			<!-- /wp:paragraph -->
