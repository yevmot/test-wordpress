...
return array(
	...
	'content'    => '
			<!-- wp:group {"backgroundColor":"dark","layout":{"inherit":false,"contentSize":"1170px"}} -->
			...
			<!-- wp:navigation {"textColor":"light","overlayMenu":"never","textColor":"background","layout":{"type":"flex","justifyContent":"center","orientation":"horizontal"},"className":"ona-text-letter-spacing","style":{"typography":{"textTransform":"uppercase"}},"fontSize":"tiny"} -->
			<!-- wp:home-link {"label":"' . esc_html__( 'Home', 'ona' ) . '"} /-->
			<!-- wp:navigation-link {"label":"' . esc_html__( 'About', 'ona' ) . '","type":"page","id":224,"url":"#","kind":"post-type","isTopLevelLink":true} /-->
			<!-- wp:navigation-link {"label":"' . esc_html__( 'Contact', 'ona' ) . '","type":"page","id":224,"url":"#","kind":"post-type","isTopLevelLink":true} /-->
			<!-- /wp:navigation -->			
			...
			<!-- wp:site-title {"textAlign":"center","style":{"typography":{"textTransform":"uppercase","letterSpacing":"10px","fontSize":"1.875rem","lineHeight":"1.5"},"elements":{"link":{"color":{"text":"var:preset|color|light"}}}},"className":"ona-site-title","fontFamily":"base"} /-->

			<!-- wp:site-tagline {"textAlign":"center","style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"light"} /-->
